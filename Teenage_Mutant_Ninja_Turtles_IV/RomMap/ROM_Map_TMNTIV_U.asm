...
macro TMNTIV_GameSpecificAssemblySettings()
	...
	%SetROMToAssembleForHack(TMNTIV_U, !ROMID)
endmacro
...
macro TMNTIV_GlobalAssemblySettings()
	...
	!Define_Global_ReleaseDate = "August 1992"
	!Define_Global_BaseROMMD5Hash = "807009d25eb31559974daa3e39eeccd7"
