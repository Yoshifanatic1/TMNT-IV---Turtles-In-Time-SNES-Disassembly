...
macro TMNTIV_GameSpecificAssemblySettings()
	...
	%SetROMToAssembleForHack(TMNTIV_A, !ROMID)
endmacro
...
macro TMNTIV_GlobalAssemblySettings()
	...
	!Define_Global_BaseROMMD5Hash = "1481a235fb9a9cc6de00d85fa22505c4"
	...
	!Define_Global_InternalName = "T.M.N.T.4            "
	...
	!Define_Global_Region = !Region_Europe			; Note: This should be !Region_Australia. Seems Konami forgot.
	!Define_Global_LicenseeID = $A4
	!Define_Global_VersionNumber = $00
	!Define_Global_ChecksumCompliment = !Define_Global_Checksum^$FFFF
	!Define_Global_Checksum = $3A12
...
TMNTIV_SPC700Block0Start:
	%SPC700_TMNTIV_SPC700_Engine($0400)
TMNTIV_SPC700Block0End:
endmacro
